...
/// <summary>Rotates the combat body in the screen plane around the cinematic focus.</summary>
internal static class PlanarPivotSpinAnimation
{
        ...
        string? cueTriggerName = null)
    {
        ...
        if (!string.IsNullOrWhiteSpace(cueTriggerName))
        {
    ...
    private static void LogMissingRigOnce()
    {
        ...
        Entry.Logger.Warn("Planar pivot spin skipped because AirborneAnchor or CinematicFocus was unavailable.");
    }
