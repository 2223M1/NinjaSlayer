...
public sealed class ComboFist : NinjaSlayerXAttackCard
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        ...
        new ComputedDynamicVar(
            "CalculatedHits",
            0m,
            card => card is ComboFist combo ? combo.ResolveXHitCount() : 0m)
    ];

    public ComboFist() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary) { }
