...
public static class NinjaSlayerWorldVisualProfile
{
    ...
    public static class Merchant
    {
        ...
        private const float TextureHeight = 770f;
        private const float FootTextureY = 711f;
        private const float BottomBaselineY = 20f;
        public const float BodyPositionY = BottomBaselineY - (FootTextureY - TextureHeight * 0.5f) * BodyScale;
        public const string IdleTexturePath =
            "res://NinjaSlayer/images/characters/ninja_slayer/merchant/ninja_slayer_merchant_source_cutout.png";
