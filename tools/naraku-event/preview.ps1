...
Copy-Item -LiteralPath (Join-Path $repo '.godot/mono/temp/bin/Debug/NinjaSlayer.dll') -Destination $mod -Force
Copy-Item -LiteralPath (Join-Path $Root 'NinjaSlayer.pck') -Destination $mod -Force
