...
2. [Content authoring](../content-authoring-toolkit/index.md)
3. One feature page: character, settings, persistence, audio, or patching
4. [Diagnostics and compatibility](../diagnostics-and-compatibility/index.md) before release
...
2. [内容编写](../content-authoring-toolkit/index.md)
3. 选择一个正在使用的专题：角色、设置、持久化、音频或补丁
4. 发布前阅读 [诊断与兼容](../diagnostics-and-compatibility/index.md)
