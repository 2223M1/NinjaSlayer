...
For game API differences that affect event availability, check [Diagnostics and compatibility](../diagnostics-and-compatibility/index.md).
...
影响事件可用性的游戏 API 差异见 [诊断与兼容](../diagnostics-and-compatibility/index.md)。
