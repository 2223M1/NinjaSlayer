...
- Registration APIs: [Content authoring](../content-authoring-toolkit/index.md)
- Localization keys: [Localization and keywords](../localization-and-keywords/index.md)
- Characters: [Character and unlock scaffolding](../character-and-unlock-scaffolding/index.md)
- Saves: [Persistence](../persistence-guide/index.md)
- Settings: [Mod settings](../mod-settings/index.md)
...
- 注册 API：[内容编写](../content-authoring-toolkit/index.md)
- 本地化键：[本地化与关键词](../localization-and-keywords/index.md)
- 角色：[角色与解锁脚手架](../character-and-unlock-scaffolding/index.md)
- 存档：[持久化](../persistence-guide/index.md)
- 设置：[Mod 设置](../mod-settings/index.md)
