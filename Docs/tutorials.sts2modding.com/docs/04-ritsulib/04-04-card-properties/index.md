...
<!-- Source: https://tutorials.sts2modding.com/docs/04-ritsulib/04-04-card-properties/ -->
...
通过`ritsulib`的`WithSharedTooltip`可以添加tooltip。如果不需要添加本地化文本，就不添加这行。
如果你只是个简单的数值，这样就行：
...
[English](/en/docs/04-ritsulib/04-04-card-properties/)
