...
<!-- Source: https://tutorials.sts2modding.com/docs/04-ritsulib/04-02-custom-config/ -->

RitsuLib 提供三种方式创建配置页面：代码流式构建、反射属性注册、Schema 声明注册。
配置数据的持久化由 `ModDataStore` 承担。
...
`[ModSettingsChoice]`
选项
`[ModSettingsIntSlider]`
整数滑条
`[ModSettingsKeyBinding]`
快捷键
`[ModSettingsString]`
单行文本
`[ModSettingsButton]`
按钮
`[ModSettingsMultilineString]`
多行文本
