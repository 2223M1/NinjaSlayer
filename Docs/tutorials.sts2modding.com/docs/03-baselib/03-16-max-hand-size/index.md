...
<!-- Source: https://tutorials.sts2modding.com/docs/03-baselib/03-16-max-hand-size/ -->
...
```
如果你想获取一个玩家的手牌上限，请使用`MaxHandSizePatch.GetMaxHandSize(player)`而不是`10`。
...
[English](/en/docs/03-baselib/03-16-max-hand-size/)
