...
[2026年03月25日]()[1.6k 字]()[大概 7 分钟]()[Reme]()
...
`PercentLess`把0.75变成25%。 | `额外造成{Boost:percentMore()}%伤害。`
...
| `list` | 拼接 | [https://github.com/axuno/SmartFormat/wiki/v2-Lists](https://github.com/axuno/SmartFormat/wiki/v2-Lists)
