<!-- Source: https://tutorials.sts2modding.com/docs/06-style-art-drawing/ -->
<!-- Synced: 2026-06-17 14:40:26 +08:00 -->

# 风格原画绘制

[2026年03月16日]()[1.2k 字]()[大概 4 分钟]()[未设置]()
...
- `数位板/笔`（最经典的板绘套装，甚至只要百元级别的配置就可以实现板绘的所有功能，并且由于是坐姿工作，对腰和颈椎很友好。）
- `数位屏/笔`（数位屏相较于数位板好控制的多，但是价格也更加昂贵，且便宜的数位版会有明显色差）
- `ipad/Apple Pencil`（ipad是最适合新手板绘的工具，无论是颜色还是操作方式都十分流畅）
...
- `PS/PhotoShop`（最经典的绘画软件，正版价格为88元/月。使用盗版会不时强制退出，有些麻烦）
- `CSP`（专业板绘人士使用的软件，正版价格需一次性付费429元，功能齐全）
- `krita`（长期更新的绘画软件，免费开源下载，但稍有些BUG）
- `Procrate`（仅限ipad使用，AppStore上售价88元，简单易上手）
